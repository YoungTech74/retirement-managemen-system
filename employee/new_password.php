...
if(isset($_POST['forgot_password_btn'])){
    ...
    if($password !== $confirm_password){
        ...
        $updatePassword = mysqli_query($conn, "UPDATE employees SET password = '$hashPassword' WHERE id = '$emp_id'");
...
<head>
  ...
  <link rel='stylesheet prefetch' href='https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css'>
      ...
      <link rel="stylesheet" href="./css/login2_.css">
      <link rel="stylesheet" href="./includes/bootstrapcss/css/bootstrap.min.css">
